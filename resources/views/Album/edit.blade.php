...
<body>
	...
	<table>
		...
		<div class="col-sm-5">
			<input type="text" name="album_name" value="{{ $rows->album_name}}" style="background-color: #87CEEB; color: white" class="form-control" id="inputEmail3">
		</div>
		</div>
		...
		<div class="col-sm-5">
			<select name="artist_id" class="form-control" style="background-color: #87CEEB; color: white">
