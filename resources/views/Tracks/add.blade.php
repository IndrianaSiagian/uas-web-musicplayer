	...
	<h2>Input Data Tracks</h2>
			...
			@csrf
				<table>					
					...
					<div class="col-sm-5">
							<input type="text" name="tracks_name" class=" form-control" id="inputEmail3"style="color: white; background-color:#87CEEB">
					</div>
					</div>
					...
					<div class="col-sm-5">
							<input type="text" name="tracks_time" class=" form-control" id="inputEmail3"style="color: white; background-color: #87CEEB">
					</div>
					</div>
