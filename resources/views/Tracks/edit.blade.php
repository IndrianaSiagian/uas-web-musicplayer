...
<body>
	...
	<table>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_name" value="{{ $rows->tracks_name}}" style="background-color: #87CEEB; color: white" class="form-control" id="inputEmail3">
		</div>
		</div>
		...
		<div class="col-sm-5">
			<select name="album_id" class="form-control" style="background-color: #87CEEB; color: white">
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_time" value="{{ $rows->tracks_time}}" style="background-color: #87CEEB; color: white" class="form-control" id="inputEmail3">
		</div>
		</div>
